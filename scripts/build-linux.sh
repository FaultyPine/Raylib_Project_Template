...
#       not anymore, I changed it to abs path    - pine
RAYLIB_SRC="/mnt/c/raylib/raylib/src"
...
RAYLIB_SRC="$RAYLIB_SRC" # abs path

SOURCES=""
for i in $(find src/ -name '*.c'); do SOURCES="$SOURCES $ROOT_DIR/$i"; done
